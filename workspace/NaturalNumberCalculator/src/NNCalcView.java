...
public interface NNCalcView extends ActionListener {
    ...
    /**
     * Set memory button label's visual indicator for whether a value is stored.
     * Part of 'Additional Activities'.
     *
     * @param isStored
     *            true iff a value is stored in memory (memory value != 0)
     */
    void setMemButtonLabelState(boolean isStored);
    ...
    /**
     * Updates display of whether memory operation is allowed. Part of
     * 'Additional Activities'.
     *
     * @param allowed
     *            true iff memory is allowed
     */
    void updateMemAllowed(boolean allowed);
}

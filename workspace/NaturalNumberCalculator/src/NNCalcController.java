...
public interface NNCalcController {
    ...
    /**
     * Processes event to store/recall bottom operand to memory. Part of
     * 'Additional Activities'.
     *
     * @updates this.model.bottom, this.view
     * @ensures <pre>
     * if this.model.mem = 0
     *     [this.model.mem = #this.model.bottom and this.model.bottom = 0]
     * else
     *     [this.model.bottom = #this.model.mem and this.model.mem = 0]
     * and [this.view.bMem text has been updated
     * and this.view has been updated to match this.model]
     * </pre>
     */
    void processMemEvent();

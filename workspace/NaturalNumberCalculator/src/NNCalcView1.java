...
public final class NNCalcView1 extends JFrame implements NNCalcView {
     ...
     */
    private final JButton bClear, bSwap, bEnter, bMem, bAdd, bSubtract,
            bMultiply, bDivide, bPower, bRoot;
    ...
    public NNCalcView1() {
         ...
         */
        super("àireamhair àireamh nàdarra");
        ...
        this.bClear = new JButton("sguab ⌫");
        this.bSwap = new JButton("suaip ↔");
        this.bEnter = new JButton("cuir a-steach ✓");
        this.bMem = new JButton("cuimhne [☐]");
        ...
        for (Component c : buttonPanel.getComponents()) {
            JButton jb = (JButton) c; // Can safely assume all components are JButtons
    ...
    @Override
    public void setMemButtonLabelState(boolean isStored) {
        if (isStored) {
            this.bMem.setText("cuimhne [■]");
        } else {
            this.bMem.setText("cuimhne [☐]");
        }
    }
    ...
    public void updateTopDisplay(NaturalNumber n) {
        this.tTop.setText(String.valueOf(n));
    }

    @Override
    public void updateBottomDisplay(NaturalNumber n) {
        this.tBottom.setText(String.valueOf(n));
    }
    ...
    @Override
    public void updateMemAllowed(boolean allowed) {
        this.bMem.setEnabled(allowed);
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == this.bClear) {
            ...
            this.currentState = State.SAW_ENTER_OR_SWAP;
        } else if (source == this.bMem) {
            this.controller.processMemEvent();

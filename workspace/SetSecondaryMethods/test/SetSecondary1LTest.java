...
public final class SetSecondary1LTest {
    ...
    @Test
    public final void testIsSubsetEmptyEmpty() {
        Set<String> s1 = createFromArgs();
        Set<String> s2 = createFromArgs();
    ...
    @Test
    public final void testIsSubsetProperSubset() {
        Set<String> s1 = createFromArgs("a", "b");
        Set<String> s2 = createFromArgs("a", "b", "c");

        assertTrue(s1.isSubset(s2));
    }

    @Test
    public final void testIsSubsetNonpluralImproperSubset() {
        Set<String> s1 = createFromArgs("a");
        Set<String> s2 = createFromArgs("a");

        assertTrue(s1.isSubset(s2));
    }

    @Test
    public final void testIsSubsetPluralImproperSubset() {
        Set<String> s1 = createFromArgs("a", "b");
        Set<String> s2 = createFromArgs("a", "b");

        assertTrue(s1.isSubset(s2));
    }

    @Test
    public final void testIsSubsetDiffValueImproperSubset() {
        Set<String> s1 = createFromArgs("a", "c");
        Set<String> s2 = createFromArgs("a", "b");

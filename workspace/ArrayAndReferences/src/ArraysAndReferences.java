...
public final class ArraysAndReferences {
    ...
    private static void computePartialProducts(NaturalNumber[] nnArray) {
        ...
        for (int i = nnArray.length - 1; i >= 0; i--) {
            nnArray[i] = productOfArrayElements(Arrays.copyOf(nnArray, i + 1));
        }
    }
    ...
    private static NaturalNumber[] partialProducts(NaturalNumber[] nnArray) {
        ...
        NaturalNumber[] nnCopy = Arrays.copyOf(nnArray, nnArray.length);
        computePartialProducts(nnCopy);
        return nnCopy;
    }
    ...
    public static void main(String[] args) {
        ...
        /*
         * Initialize an array of NaturalNumbers with values 1 through array
         * length.
         */
        NaturalNumber[] array = new NaturalNumber[arrayLength];
